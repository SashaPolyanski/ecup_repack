...
const MainDescriptionDesc = styled(Typography)`
  font-size: 18px;
`;
export const MainDescriptionText: FC<MainDescriptionTextProps> = ({
  desc,
  title,
  gradient,
}) => {
  return (
    <MainDescriptionTextContainer>
      <MainDescriptionTitle $gradient={gradient}>{title}</MainDescriptionTitle>
      <MainDescriptionDesc>{desc}</MainDescriptionDesc>
    </MainDescriptionTextContainer>
  );
};

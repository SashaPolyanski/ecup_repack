...
const TournamentStreamContainer = styled(Box)`
  ...
  text-align: center;
`;
export const TournamentStreamComponent: FC<
  withTournamentPkProps & WithGamePkProps
> = ({ tournamentPk, gamePk }) => {
...
export const TournamentStream = withTournamentPk()(
  withGamePk()(TournamentStreamComponent),
);

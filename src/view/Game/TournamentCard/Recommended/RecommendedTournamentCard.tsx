...
`;
export const RecommendedTournamentCardComponent: FC<
...
export const RecommendedTournamentCard: FC<TournamentCardProps> = withGamePk()(
  RecommendedTournamentCardComponent,
);

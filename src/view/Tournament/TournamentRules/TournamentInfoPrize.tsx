...
`;
const OverviewTabPrizesDescr = styled(Typography)`
  color: #a0aec0;
  font-size: 16px;
  font-weight: 400;
  line-height: 24px;
...
`;
export const TournamentInfoPrizeItem: FC<TournamentPrizeInfoItemProps> = ({
  icon,
  place,
  moneys,
  coins,
...
export const TournamentInfoPrizeComponent: FC<TournamentInfoPrizeProps> = ({
  tournamentPk,
  gamePk,
}) => {
  const { t } = useTranslation("common");
  ...
  const prizeItems = [
    {
      place: 1,
      icon: <Gold />,
      moneys: moneyPrizes[0],
      coins: virtualPrizes[0],
      id: 1,
    },
    {
      place: 2,
      icon: <Silver />,
      moneys: moneyPrizes[1],
      coins: virtualPrizes[1],
      id: 2,
    },
    {
      place: 3,
      icon: <Bronze />,
      moneys: moneyPrizes[2],
      coins: virtualPrizes[2],
      id: 3,
    },
  ...
  return (
    <TournamentTabInfoPrizeComponentContainer>
      ...
      <Box>
        <OverviewTabPrizesDescr>{t("prizeInfo")}</OverviewTabPrizesDescr>
      </Box>
    </TournamentTabInfoPrizeComponentContainer>
  );
};
export const TournamentInfoPrize = withTournamentPk()(
  withGamePk()(TournamentInfoPrizeComponent),
);

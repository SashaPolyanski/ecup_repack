...
export const TournamentScheduleComponent: FC<TournamentScheduleProps> = ({
  tournamentPk,
  gamePk,
}) => {
  ...
  return <TournamentStepper schedule={data?.schedule} />;
};
export const TournamentSchedule = withTournamentPk()(
  withGamePk()(TournamentScheduleComponent),
);
